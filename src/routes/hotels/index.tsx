...
export const Route = createFileRoute('/hotels/')({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://allbrothersconsult.com/hotels" },
    ...
    links: [
      { rel: "canonical", href: "https://allbrothersconsult.com/hotels" },
    ],
  }),
  component: Hotels,
})
    ...
    <SiteLayout>
      ...
      <section className="mx-auto max-w-[1400px] px-6 lg:px-10 py-16">
        <div className="grid md:grid-cols-2 gap-x-10 gap-y-20">
          {filtered.map((h, i) => (
            <Link key={h.id} to="/hotels/$id" params={{ id: h.id }} className="group block">
